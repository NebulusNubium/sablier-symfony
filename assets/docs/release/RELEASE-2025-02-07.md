...
- Page d’accueil, page de connexion, page d’inscription, page de gallerie d'articles, page avec détail d'un article et espace de commentaire, page de formulaire avec envoie d'email
